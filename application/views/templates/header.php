...
<html lang="en">
  ...
  <body style="background-image:url('<?php echo base_url() ;?>assets/img/pat.jpg');background-repeat :repeat;background-size:20%; ">
    ...
    <!--Page Content-->
    <!--Header Begins-->
    <div class="texture container" style="box-shadow:0 3px 6px 0 rgba(0,0,0,0.5);background-color:white;">
    ...
    <a class="logo" href="<?php echo base_url() ;?>" ><img src="<?php echo base_url() ;?>assets/img/Spic_logo.png" class="img-responsive" style="width:80%;" alt="logo"></a></div>
        <nav class="navbar navbar-expand-lg fixed" id="navb" style="margin-bottom:10px;">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
              <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo base_url() ;?>contacts">Contact Us <span class="sr-only">(current)</span></a>
                </li>
              </ul>
            ...
            <div class="user_data">
              <?php if (!$this->session->userdata('logged_in')) { ?>
                  <a href="<?php echo base_url(); ?>login" class="nav-link pull-left">Log In </a>
                                  ...
                                  <div class="dropdown" style="z-index:1000;padding:.5rem 0;">
                                          ...
                                          <ul class="dropdown-menu" id="user_drop" style="z-index:1000";>
                                            <?php if($this->session->userdata('role') == '1') { ?>
                                              <li class="nav-item"><a href=" <?php echo base_url(); ?>panel" style="text-transform: none;" class="nav-link">Admin Panel</a></li>
                                              <?php } ?>
